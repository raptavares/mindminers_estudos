        ...
        switch ($opt_theme_options['page_title_layout']) {
            ...
            case '3':
                ...
                <div id="cms-page-title" class="page-title pt-style3" style="background-image: url(<?php echo esc_url($opt_theme_options['bg_page_title']['url']); ?>)">
                    <div class="container">
                        <div class="row">
                            <div class="cms-page-title-inner col-xs-12 col-sm-12 col-md-6 col-lg-6 text-center-xs text-center-sm">
                                <h1><?php whole_get_page_title(); ?></h1>
                            </div>
                            <?php if(empty($opt_theme_options['hidden_breadcrumb'])) { ?>
                                <div class="cms-breadcrumb col-xs-12 col-sm-12 col-md-6 col-lg-6 text-right text-center-xs text-center-sm">
                                    <?php whole_get_bread_crumb(); ?>
                                </div>
                            <?php } ?>
                        </div>
...
function whole_get_page_title(){
    ...
    if (!is_archive()){
        ...
        /* search */
        elseif (is_search()):
            printf( esc_html__( 'Search Results for: %s', 'whole' ), '<cite>' . get_search_query() . '</cite>' );
        /* 404 */
        elseif (is_404()):
            esc_html_e( '404 Error', 'whole');
        /* Single Post */
        ...
        /* author. */
        elseif ( is_author() ) :
            printf( esc_html__( 'Author: %s', 'whole' ), '<span class="vcard">' . get_the_author() . '</span>' );
        /* date */
        elseif ( is_day() ) :
            printf( esc_html__( 'Day: %s', 'whole' ), '<span>' . get_the_date() . '</span>' );
        elseif ( is_month() ) :
            printf( esc_html__( 'Month: %s', 'whole' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'whole' ) ) . '</span>' );
        elseif ( is_year() ) :
            printf( esc_html__( 'Year: %s', 'whole' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'whole' ) ) . '</span>' );
        /* post format */
