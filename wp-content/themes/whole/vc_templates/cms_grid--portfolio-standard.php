...
?>
<div class="cms-grid-wraper cms-portfolio cms-portfolio-standard <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
            ...
            <div class="cms-grid-item <?php echo esc_attr($atts['item_class']);?>" data-groups='[<?php echo implode(',', $groups);?>]'>
                ...
                <div class="cms-portfolio-wrapper">
                    <div class="cms-portfolio-image">
                        ...
                        <a class="cms-portfolio-overlay" href="<?php the_permalink(); ?>"><span class="ft-pl">+</span></a>
                    </div>
    ...
    <?php 
        if($nav_show_hide == 'show') {
            if($nav_style == 'loadmore') {
                echo '<div class="cms_pagination text-center '.$btn_load_style.'"></div>';
            } else {
                whole_paging_nav();
            }
        }
